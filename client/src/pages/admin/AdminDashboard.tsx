        ...
        .back-btn {
          ...
          transition: all 0.2s;
                :root {
                  ...
                  --admin-panel-border: rgba(148, 163, 184, 0.18);
                  --admin-text: #0f172a;
                  --admin-muted: #64748b;
                ...
                <div className="admin-shell">
                  <aside className="sidebar">
                    ...
                    <div className="sidebar-copy">
                      ...
                      <p>Review users, verify doctors, and track transactions with clear, low-noise controls.</p>
                    </div>
                    ...
                    <nav className="sidebar-nav" aria-label="Dashboard sections">
                      <button className={`sidebar-tab ${activeTab === 'overview' ? 'active' : ''}`} onClick={() => setActiveTab('overview')}>
                        <span className="tab-label"><Activity size={18} /> Overview</span>
                        <TrendingUp size={16} />
                      </button>

                      <button className={`sidebar-tab ${activeTab === 'users' ? 'active' : ''}`} onClick={() => setActiveTab('users')}>
                        <span className="tab-label"><Users size={18} /> User Management</span>
                        <FileText size={16} />
                      </button>

                      <button className={`sidebar-tab ${activeTab === 'doctors' ? 'active' : ''}`} onClick={() => setActiveTab('doctors')}>
                        <span className="tab-label"><UserCheck size={18} /> Doctor Verification</span>
                        <AlertCircle size={16} />
                      </button>

                      <button className={`sidebar-tab ${activeTab === 'transactions' ? 'active' : ''}`} onClick={() => setActiveTab('transactions')}>
                        <span className="tab-label"><DollarSign size={18} /> Financial Transactions</span>
                        <Clock size={16} />
                      </button>
                    </nav>
                    ...
                    <div className="main-header">
                      <div>
                        ...
                        <p className="main-subtitle">
                          A cleaner control surface for managing the platform, with deeper contrast, modern gray surfaces, and responsive cards.
                        </p>
                      </div>

                      <div className="header-chips">
                        <div className="chip"><Calendar size={14} /> Today</div>
                        <div className="chip"><TrendingUp size={14} /> Live overview</div>
                      </div>
                    </div>
                        ...
                        <section className="table-card">
                          <div className="card-header">
                            <div>
                              ...
                              <p className="card-meta">Search, filter, and review the current platform users.</p>
                            </div>
                                ...
                                <tbody>
                                  {filteredByRole.map((user) => (
                                    <tr key={user._id}>
                                      ...
                                      <td>
                                        <span className="status-badge" style={{ background: user.isApproved ? '#0f766e' : '#b45309' }}>
                        ...
                        <section className="table-card">
                          <div className="card-header">
                            <div>
                              ...
                              <p className="card-meta">Review applications and handle approval actions from the table below.</p>
                            </div>
                                ...
                                <tbody>
                                  {filteredDoctorApplications.map((app) => (
                                    <tr key={app._id}>
                                      ...
                                      <td>
                                        <div className="action-group">
                                          <button className="action-btn info" onClick={() => handleViewDoctorDetails(app)} aria-label="View application">
                                            <Eye size={16} />
                                          </button>
                                          {app.status === 'pending' && (
                                            <>
                                              <button className="action-btn approve" onClick={() => handleApproveDoctor(app._id)} aria-label="Approve doctor">
                                                <CheckCircle size={16} />
                                              </button>
                                              <button className="action-btn reject" onClick={() => handleRejectDoctor(app._id)} aria-label="Reject doctor">
                                                <UserX size={16} />
                                              </button>
                                            </>
                                          )}
                                          {(app.status === 'approved' || app.status === 'rejected') && (
                                            <button className="action-btn warn" onClick={() => handleBlockDoctor(app._id)} aria-label="Block doctor">
                                              <AlertTriangle size={16} />
                                            </button>
                                          )}
                                          {app.status === 'blocked' && (
                                            <button className="action-btn approve" onClick={() => handleUnblockDoctor(app._id)} aria-label="Unblock doctor">
                                              <CheckCircle size={16} />
                                            </button>
                                          )}
                                        </div>
                        ...
                        <section className="table-card">
                          <div className="card-header">
                            <div>
                              ...
                              <p className="card-meta">Review payments, refunds, and subscription activity in one place.</p>
                            </div>
                                ...
                                <tbody>
                                  {filteredByType.map((transaction) => (
                                    <tr key={transaction._id}>
                                      ...
                                      <td>
                                        <span className="status-badge" style={{ background: getTypeColor(transaction.type) }}>
                                      ...
                                      <td>
                                        <span className="status-badge" style={{ background: getStatusColor(transaction.status) }}>
