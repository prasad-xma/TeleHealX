...
// POST /api/notifications/appointment-cancelled - Send appointment cancelled notifications
router.post('/appointment-cancelled', notificationController.sendAppointmentCancelledNotifications);
